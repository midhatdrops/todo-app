...
export default class Todo extends Component {
  ...
  render() {
    return(<div>
      ...
      <Form handleAdd={this.handleAdd} description={this.state.description} handleChange={this.handleChange} handleSearch={this.handleSearch} handleClear={this.handleClear}/>
